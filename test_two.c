...
main()
{
   ...
   setcolor(15);
   settextstyle(10,0,9);
   outtextxy(205,60,(char*)"poraik");
   settextstyle(10,0,5);
   outtextxy(310,150,(char*)"(^_^)");
   ...
   setcolor(4);
   settextstyle(10,0,1);
   outtextxy(200,70,(char*)"sine wave");
   for (x = 180; x < 565; x++)
   {
   ...
   setcolor(1);
   outtextxy(190,220,(char*)"cosine wave");

   getch();
   closegraph();
}
/* -------------------------------------------------------
 coded By Mohaamed_Ismail
 Created on 10.3.2022
 My email : hesham.mo.poraik@gmail.com
 -------------------------------------------------------*/